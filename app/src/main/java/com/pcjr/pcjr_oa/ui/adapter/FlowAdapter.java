...
public class FlowAdapter extends BaseQuickAdapter<Flow, BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder helper, Flow item) {
        switch (item.getStatus()) {
            case 0 :
                helper.setTextColor(R.id.img_icon,R.mipmap.icon_flow_submit);
                ...
                break;
            case 1:
                helper.setTextColor(R.id.img_icon,R.mipmap.icon_flow_ok);
                helper.setTextColor(R.id.txt_title,R.color.color_explain);
                helper.setBackgroundRes(R.id.ll_background,R.drawable.left_border_green);
                helper.setVisible(R.id.ll_content,true);
                break;
            case 2 :
                helper.setTextColor(R.id.img_icon,R.mipmap.icon_flow_pending);
                ...
                break;
            case 3 :
                helper.setTextColor(R.id.img_icon,R.mipmap.icon_flow_return);
                ...
                break;
            case 4 :
                helper.setTextColor(R.id.img_icon,R.mipmap.icon_flow_pending_gray);
                helper.setTextColor(R.id.txt_title,R.color.color_explain);
                helper.setBackgroundRes(R.id.ll_background,R.drawable.left_border_gray);
                helper.setVisible(R.id.ll_content,true);
                break;
            case 5 :
                helper.setTextColor(R.id.img_icon,R.mipmap.icon_flow_finish);
